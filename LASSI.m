function [L, S, D, B, stats] = LASSI(Y,lambdaL,lambdaS,lambdaB,varargin)
%
% Syntax:       [L, S, D, B] = LASSI(Y,lambdaL,lambdaS,lambdaB);
%               [L, S, D, B] = LASSI(Y,lambdaL,lambdaS,lambdaB,opts);
%               [L, S, D, B, stats] = LASSI(Y,lambdaL,lambdaS,lambdaB);
%               [L, S, D, B, stats] = LASSI(Y,lambdaL,lambdaS,lambdaB,opts);
%               
...
%                   elements specifying the patch strides (i.e., shifts) to
...
%               
% Description:  Solves one of the following LASSI (low-rank and adaptive
%               sparse signal model) problems:
%               
%               When type == 'hard':
%               
...
%               
%               
% References:   S. Ravishankar, B. E. Moore, R. R. Nadakuditi, and J. A.
%               Fessler, "Low-rank and adaptive sparse signal (LASSI)
%               models for highly accelerated dynamic imaging," IEEE
%               Transactions on Medical Imaging, vol. 36, no. 5, pp.
%               1116-1128, May 2017.
%               
%               S. Ravishankar, B. E. Moore, R. R. Nadakuditi, and J. A.
%               Fessler, "LASSI: A low-rank and adaptive sparse signal
%               model for highly accelerated dynamic imaging," in IEEE
%               Image, Video, and Multidimensional Signal Processing
%               Workshop (IVMSP), July 2016, pp. 1-5.
%               
%
